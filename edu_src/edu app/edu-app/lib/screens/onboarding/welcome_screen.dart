            ...
            child: Column(
              children: [
                ...
                _RoleCard(
                  ...
                  onTap: () => context.go(AppRoutes.teacherSignUp),
                ),
                const SizedBox(height: 22),
                TextButton(
                  onPressed: _adminSubmitting ? null : _continueAsAdmin,
                  child: Text(
                    _adminSubmitting ? 'Signing in…' : 'Continue as Admin',
                    style: const TextStyle(color: AppBrand.inkSoft, fontWeight: FontWeight.w700),
                  ),
                ),
              ],
            ),
