...
import '../../screens/onboarding/teacher_signup_screen.dart';
...
class AppRoutes {
  ...
  static const teacherSignUp = '/auth/teacher/signup';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // Every screen reachable before signing in: the Welcome screen plus
      // the student/teacher sign-up + sign-in screens (and the legacy
      // onboarding route, kept for backwards compatibility).
      const authRoutes = {
