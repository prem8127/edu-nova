        ...
        children: [
          ...
          if (narrow)
            Align(
              ...
              child: _BottomNav(modules: visibleModules.take(5).toList(), selected: module, onSelect: selectModule),
            ),
          Positioned(
            right: 22,
            bottom: narrow ? 92 : 24,
...
class _Brand extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        if (!compact) ...[
          const SizedBox(width: 10),
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('EduCloud', style: Theme.of(context).textTheme.titleLarge?.copyWith(height: 1)),
            Text('School SaaS', style: Theme.of(context).textTheme.labelSmall),
          ]),
        ],
      ]);
}
