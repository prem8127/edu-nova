                ...
                children: [
                  ...
                  Expanded(
                    child: _QuickLink(
                      ...
                      onTap: () => context.push(AppRoutes.studentCalendar),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _QuickLink(
                      ...
                      onTap: () => context.push(AppRoutes.studentDoubtChat),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: _QuickLink(
                      ...
                      label: 'Assessments',
                      color: AppBrand.blue,
                      onTap: () => context.push(AppRoutes.studentAssessments),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _QuickLink(
                      ...
                      label: 'Projects',
                      color: AppBrand.purple,
                      onTap: () => context.push(AppRoutes.studentProjects),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _QuickLink(
                      ...
                      onTap: () => context.push(AppRoutes.studentCertificates),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: _QuickLink(
                      ...
                      label: 'Leaderboard',
                      color: const Color(0xFFFF8A4C),
                      onTap: () => context.push(AppRoutes.studentLeaderboard),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _QuickLink(
                      ...
                      label: 'Arcade',
                      color: AppBrand.blue,
                      onTap: () => context.push(AppRoutes.studentGame),
                    ),
                  ),
                ],
              ),
