...
ThemeData gradeThemeFor(Grade? grade) {
  switch (grade) {
    case Grade.class6:
      return Class6Theme.theme;
    case Grade.class7:
      return Class7Theme.theme;
    case Grade.class8:
      return Class8Theme.theme;
    case Grade.class9:
      return Class9Theme.light;
    case Grade.class10:
      return Class10Theme.theme;
    case Grade.intermediate1:
      return Intermediate1Theme.theme;
    case Grade.intermediate2:
      return Intermediate2Theme.theme;
    case null:
...
class GradePalette {
  ...
  static GradePalette of(Grade? grade) {
    switch (grade) {
      case Grade.class6:
        return const GradePalette(
          grade: Grade.class6,
          name: 'Sunrise',
          primary: Class6Theme.blue,
          secondary: Class6Theme.orange,
          background: Class6Theme.bg,
          surface: Colors.white,
          onSurface: Color(0xFF16324B),
          onSurfaceMuted: Color(0xFF5E7488),
          isDark: false,
        );
      case Grade.class7:
        return const GradePalette(
          grade: Grade.class7,
          name: 'Reef',
          primary: Class7Theme.teal,
          secondary: Class7Theme.coral,
          background: Class7Theme.bg,
          surface: Colors.white,
          onSurface: Color(0xFF0E3B3B),
          onSurfaceMuted: Color(0xFF5C7C7C),
          isDark: false,
        );
      case Grade.class8:
        return const GradePalette(
          grade: Grade.class8,
          name: 'Studio',
          primary: Class8Theme.indigo,
          secondary: Class8Theme.mint,
          background: Class8Theme.bg,
          surface: Colors.white,
          onSurface: Color(0xFF20233A),
          onSurfaceMuted: Color(0xFF6B6F86),
          isDark: false,
        );
      case Grade.class9:
        return const GradePalette(
          grade: Grade.class9,
          name: 'Scholar',
          primary: Class9Theme.navy,
          secondary: Class9Theme.gold,
          background: Color(0xFFF4F6FB),
          surface: Colors.white,
          onSurface: Class9Theme.navy,
          onSurfaceMuted: Color(0xFF6A7288),
          isDark: false,
        );
      case Grade.class10:
        return const GradePalette(
          grade: Grade.class10,
          name: 'Focus',
          primary: Class10Theme.ink,
          secondary: Class10Theme.crimson,
          background: Class10Theme.bg,
          surface: Colors.white,
          onSurface: Class10Theme.ink,
          onSurfaceMuted: Color(0xFF6C7076),
          isDark: false,
        );
      case Grade.intermediate1:
        return const GradePalette(
          grade: Grade.intermediate1,
          name: 'Emerald',
          primary: Intermediate1Theme.emerald,
          secondary: Intermediate1Theme.gold,
          background: Intermediate1Theme.bg,
          surface: Intermediate1Theme.card,
          onSurface: Color(0xFFEAF6F1),
          onSurfaceMuted: Color(0xFF8FB3A8),
          isDark: true,
        );
      case Grade.intermediate2:
        return const GradePalette(
          grade: Grade.intermediate2,
          name: 'Royal',
          primary: Intermediate2Theme.violet,
          secondary: Intermediate2Theme.cyan,
          background: Intermediate2Theme.bg,
          surface: Intermediate2Theme.card,
          onSurface: Color(0xFFECEBFF),
          onSurfaceMuted: Color(0xFF9A9ECB),
          isDark: true,
        );
      case null:
        return const GradePalette(
