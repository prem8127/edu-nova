  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      ...
      builder: (context, child) {
        ...
        return _MobileFrame(child: content);
      },
    );
  }
}

/// Keeps the app phone-shaped everywhere it renders. On an actual phone
/// (narrow viewport) this is a no-op. On a wider viewport — a desktop
/// browser tab, a tablet, anyone testing the web build — it centers the UI
/// inside a fixed phone-width column with its own shadow/frame instead of
/// stretching every screen edge-to-edge like a website.
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= _phoneWidth) return child;
        return ColoredBox(
            ...
            child: SizedBox(
              ...
              child: DecoratedBox(
                ...
                child: ClipRect(child: MediaQuery(
                  // Screens key their "desktop" grid layouts off maxWidth,
                  // so pin it to the phone width even though the browser
                  // window itself is wider.
