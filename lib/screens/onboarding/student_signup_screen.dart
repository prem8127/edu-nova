...
class _StudentSignUpScreenState extends ConsumerState<StudentSignUpScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Account exists but is unconfirmed — send them to enter the OTP
      // emailed to them before they get a session.
      if (mounted) context.push(AppRoutes.studentVerifyOtp, extra: email);
