...
class AppDrawer extends ConsumerWidget {
  ...
  static const _student = [
    ...
    _DrawerNavItem('Syllabus', Icons.map_rounded, route: AppRoutes.studentSyllabus),
  ...
  static const _teacher = [
    ...
    _DrawerNavItem('My Students', Icons.groups_rounded, route: AppRoutes.teacherMyStudents),
    _DrawerNavItem('My Courses', Icons.menu_book_rounded, route: AppRoutes.teacherAssignedCourses),
    ...
    _DrawerNavItem('Upload Content', Icons.upload_rounded, route: AppRoutes.teacherContentUpload),
    _DrawerNavItem('Batches', Icons.school_rounded, route: AppRoutes.teacherBatches),
    _DrawerNavItem('Syllabus', Icons.map_rounded, route: AppRoutes.teacherSyllabus),
  ...
  static const _admin = [
    ...
    _DrawerNavItem('Syllabus', Icons.map_rounded, route: AppRoutes.adminSyllabus),
    ...
    _DrawerNavItem('Revenue', Icons.trending_up_rounded, route: AppRoutes.adminRevenue),
    _DrawerNavItem('Payments', Icons.payments_rounded, route: AppRoutes.adminPayments),
