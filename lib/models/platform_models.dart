...
/// A read-only progress summary a parent can view for their child. Aggregated
/// on demand from attendance, submissions and certificates.
class ParentReport {
  final String studentId;
  final String studentName;
  ...
  const ParentReport({
    ...
    required this.assignmentsApproved,
